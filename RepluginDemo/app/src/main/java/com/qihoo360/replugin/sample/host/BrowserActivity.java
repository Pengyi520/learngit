...
import com.qihoo360.replugin.sample.sonic.SonicJavaScriptInterface;
import com.qihoo360.replugin.sample.sonic.SonicRuntimeImpl;
import com.qihoo360.replugin.sample.sonic.SonicSessionClientImpl;
...
public class BrowserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SonicActivity.MODE_DEFAULT != mode) { // sonic mode
            SonicSessionConfig.Builder sessionConfigBuilder = new SonicSessionConfig.Builder();

            // if it's offline pkg mode, we need to intercept the session connection
            if (SonicActivity.MODE_SONIC_WITH_OFFLINE_CACHE == mode) {
